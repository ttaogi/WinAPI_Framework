...
void LoadResources()
{
	...
	// ui button.
	IMG->AddImage(KEY_UI_QUIT_BUTTON_STRIPE, UI_QUIT_BUTTON_STRIPE, BUTTON_WIDTH, BUTTON_HEIGHT, true, MAGENTA)
		->InitForAlphaBlend();
	IMG->AddImage(KEY_UI_RETRY_BUTTON_STRIPE, UI_RETRY_BUTTON_STRIPE, BUTTON_WIDTH, BUTTON_HEIGHT, true, MAGENTA)
		->InitForAlphaBlend();
	IMG->AddImage(KEY_UI_START_BUTTON_STRIPE, UI_START_BUTTON_STRIPE, 400, 50, true, MAGENTA)
		->InitForAlphaBlend();

	IMG->AddImage(KEY_UI_STAGE_1_BUTTON_STRIPE, UI_STAGE_1_BUTTON_STRIPE, 415, 155, true, MAGENTA)
		->InitForAlphaBlend();
	IMG->AddImage(KEY_UI_STAGE_2_BUTTON_STRIPE, UI_STAGE_2_BUTTON_STRIPE, 415, 155, true, MAGENTA)
		->InitForAlphaBlend();
	IMG->AddImage(KEY_UI_STAGE_3_BUTTON_STRIPE, UI_STAGE_3_BUTTON_STRIPE, 415, 155, true, MAGENTA)
		->InitForAlphaBlend();
	IMG->AddImage(KEY_UI_STAGE_4_BUTTON_STRIPE, UI_STAGE_4_BUTTON_STRIPE, 415, 155, true, MAGENTA)
		->InitForAlphaBlend();
	
	// ui bar.
	IMG->AddImage(KEY_UI_BAR_BACKGROUND_STRIPE, DIR_UI_BAR_BACKGROUND_STRIPE, 20, 20, false, MAGENTA)
		->InitForAlphaBlend();
	IMG->AddImage(KEY_UI_BAR_GUAGE_STRIPE, DIR_UI_BAR_GUAGE_STRIPE, 20, 20, false, MAGENTA)
		->InitForAlphaBlend();
	IMG->AddImage(KEY_UI_BAR_BORDER_STRIPE, DIR_UI_BAR_BORDER_STRIPE, 20, 20, false, MAGENTA)
		->InitForAlphaBlend();
	
	// platform.
	IMG->AddImage(KEY_PLATFORM_DEFAULT_STRIPE, DIR_PLATFORM_DEFAULT_STRIPE, 80, 20, false, MAGENTA)
		->InitForAlphaBlend();
	
	// player.
	IMG->AddImage(KEY_PLAYER_TEMP_STRIPE, DIR_PLAYER_TEMP_STRIPE, 80, 80, false, MAGENTA)
		->InitForAlphaBlend();
