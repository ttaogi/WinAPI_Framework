...
void LoadResources()
{
	...
	// ui button.
	IMG->AddImage(KEY_UI_QUIT_BUTTON_STRIPE, UI_QUIT_BUTTON_STRIPE, BUTTON_WIDTH, BUTTON_HEIGHT, false, MAGENTA);
	IMG->AddImage(KEY_UI_RETRY_BUTTON_STRIPE, UI_RETRY_BUTTON_STRIPE, BUTTON_WIDTH, BUTTON_HEIGHT, false, MAGENTA);
